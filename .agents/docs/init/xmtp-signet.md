...
> `README.md`, `docs/index.md`, `docs/architecture/runtime.md`,
> `docs/development.md`, and `.agents/plans/v1/v1-architecture.md` for
> implementation guidance; treat this PRD primarily as design history and
> motivation.
